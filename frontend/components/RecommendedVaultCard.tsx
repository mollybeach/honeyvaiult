  ...
  return (
    <div className="bg-slate-900 rounded-xl border border-slate-800 p-6 hover:border-green-500/30 transition-all">
      ...
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="text-white font-semibold">{vault.apr}% APR</div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center gap-2">
          {vault.assets.slice(0, 3).map((asset, index) => (
            <div
              key={index}
              className="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center border border-slate-700"
              title={asset.name}
            >
