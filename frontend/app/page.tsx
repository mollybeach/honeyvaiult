...
export default function Home() {
  ...
  // Default mock vaults matching the image - show these by default
  const defaultVaults: Vault[] = [
    ...
    },
    {
      ...
      assets: [
        ...
        { name: 'J', type: 'reit', provider: 'JPMorgan', country: 'US', rating: 'A', description: 'Industrial REIT' },
        { name: 'BL', type: 'reit', provider: 'BlackRock', country: 'US', rating: 'A+', description: 'Office REIT' },
        { name: 'E', type: 'reit', provider: 'Equity', country: 'US', rating: 'A-', description: 'Retail REIT' },
        { name: 'ST', type: 'reit', provider: 'State Street', country: 'US', rating: 'A-', description: 'Mixed REIT' },
      ],
      riskTier: 2,
    },
    {
  ...
  const [recommendedVaults, setRecommendedVaults] = useState<Vault[]>(defaultVaults);
  ...
  const handleFindVaults = async (_preferences: VaultPreferences) => {
    ...
    // For now, return the default vaults
    setRecommendedVaults(defaultVaults);
  };
